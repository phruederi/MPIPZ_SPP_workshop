...
${SEQTK_PATH}/seqtk subseq ${CLEAN_PATH}/Col0_p_rep1_R1.fq.gz Col0_p_rep1_rnames.txt | /bin/gzip > ${SELECT_PATH}/Col0_p_rep1_select_R1.fq.gz

${SEQTK_PATH}/seqtk subseq ${CLEAN_PATH}/Col0_p_rep1_R2.fq.gz Col0_p_rep1_rnames.txt | /bin/gzip > ${SELECT_PATH}/Col0_p_rep1_select_R2.fq.gz

${SEQTK_PATH}/seqtk subseq ${CLEAN_PATH}/flg22_p_rep1_R1.fq.gz flg22_p_rep1_rnames.txt | /bin/gzip > ${SELECT_PATH}/flg22_p_rep1_select_R1.fq.gz

${SEQTK_PATH}/seqtk subseq ${CLEAN_PATH}/flg22_p_rep1_R2.fq.gz flg22_p_rep1_rnames.txt | /bin/gzip > ${SELECT_PATH}/flg22_p_rep1_select_R2.fq.gz
